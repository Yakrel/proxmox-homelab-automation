...
const ARCHITECTURE_DATA = {
    ...
    stacks: [
        ...
        },
        {
            ...
            services: [
                { name: "Jellyfin", icon: "fa-solid fa-film", port: "8096", url: "https://jellyfin.byetgin.com", desc: { en: "Media Server (Hardware Transcoding)", tr: "Medya Sunucusu (Donanım Transcoding)" }, status: "active", gpu: true },
                { name: "Immich", icon: "fa-solid fa-images", port: "2283", url: "https://immich.byetgin.com", desc: { en: "Self-hosted Photos alternative", tr: "Self-hosted Fotoğraf alternatifi" }, status: "active", gpu: true },
        ...
        },
        {
            ...
            services: [
                ...
                { name: "Sshwifty", icon: "fa-solid fa-terminal", port: "7681", desc: { en: "Web-based SSH/Telnet Connector", tr: "Web tabanlı SSH/Telnet Konnektörü" }, status: "active" },
