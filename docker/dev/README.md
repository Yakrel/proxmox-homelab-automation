...
# - AI CLI tools (Codex CLI, Antigravity CLI, and Pi Coding Agent)
# - Automatic Agentmemory capture and context injection for Pi
...
#
# Access code-server at: http://192.168.1.105:8680
