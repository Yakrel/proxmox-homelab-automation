...
clean_dir "/datapool/config/npm/data/logs"
clean_dir "/datapool/config/code-server/data/coder-logs"
clean_dir "/datapool/config/tdarr/server/Tdarr/Logs"
...
clean_dir "/datapool/config/bazarr/backup"
clean_dir "/datapool/config/tdarr/server/Tdarr/Backups"
...
remove_dir "/datapool/config/prowlarr/Definitions"
remove_dir "/datapool/config/recyclarr/resources"
remove_dir "/datapool/config/recyclarr/repositories"
