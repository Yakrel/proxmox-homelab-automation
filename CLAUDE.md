...
### 1. **Fail Fast & Simple**
- All operations must be safely re-runnable (idempotent)
...
- **Idempotent Implementation**: Overwrite config files completely (like docker-compose.yml and .env files) to ensure consistent final state
